...
import com.blaze.agent.triggers.PermissionUtils
import com.blaze.agent.triggers.Trigger
...
//        }
    ...
    private fun saveTrigger() {
        ...
        when (selectedTriggerType) {
            TriggerType.SCHEDULED_TIME -> {
                if (!com.blaze.agent.triggers.PermissionUtils.canScheduleExactAlarms(this)) {
