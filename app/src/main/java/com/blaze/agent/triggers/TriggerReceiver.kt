package com.blaze.agent.triggers
...
class TriggerReceiver : BroadcastReceiver() {
    ...
    companion object {
        const val ACTION_EXECUTE_TASK = "com.blaze.agent.action.EXECUTE_TASK"
        const val EXTRA_TASK_INSTRUCTION = "com.blaze.agent.EXTRA_TASK_INSTRUCTION"
        const val EXTRA_TRIGGER_ID = "com.blaze.agent.EXTRA_TRIGGER_ID"
