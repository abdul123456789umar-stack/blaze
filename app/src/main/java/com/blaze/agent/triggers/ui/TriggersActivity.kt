package com.blaze.agent.triggers.ui
...
import com.blaze.agent.BaseNavigationActivity
import androidx.recyclerview.widget.LinearLayoutManager
import androidx.recyclerview.widget.RecyclerView
import com.blaze.agent.R
import com.blaze.agent.triggers.TriggerManager
import com.blaze.agent.triggers.TriggerMonitoringService
import com.blaze.agent.triggers.TriggerType
...
class TriggersActivity : BaseNavigationActivity() {
    ...
    private fun checkNotificationPermission() {
        ...
        if (hasNotificationTriggers && !com.blaze.agent.triggers.PermissionUtils.isNotificationListenerEnabled(this)) {
    ...
    private fun showDeleteConfirmationDialog(trigger: com.blaze.agent.triggers.Trigger) {
        val dialog = AlertDialog.Builder(this)
