package com.blaze.agent.api

import android.content.Context
import android.content.SharedPreferences
import android.util.Log
import androidx.core.content.edit
import com.blaze.agent.BuildConfig
import kotlinx.coroutines.Dispatchers
import kotlinx.coroutines.withContext
import okhttp3.OkHttpClient
import okhttp3.Request
import java.util.concurrent.TimeUnit
import com.blaze.agent.utilities.NetworkConnectivityManager
import com.blaze.agent.utilities.UserIdManager
    ...
    private suspend fun fetchAccessKeyFromApi(): String? = withContext(Dispatchers.IO) {
        try {
            ...
            if (!isOnline) {
                ...
                com.blaze.agent.utilities.NetworkNotifier.notifyOffline()
                return@withContext null
            }
