package com.blaze.agent.services
...
import com.blaze.agent.ConversationalAgentService
import com.blaze.agent.MainActivity
import com.blaze.agent.R
import com.blaze.agent.api.PorcupineWakeWordDetector
...
class EnhancedWakeWordService : Service() {
    ...
    companion object {
        ...
        var isRunning = false
        const val ACTION_WAKE_WORD_FAILED = "com.blaze.agent.WAKE_WORD_FAILED"
