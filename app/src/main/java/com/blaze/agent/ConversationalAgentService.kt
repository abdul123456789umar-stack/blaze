...
//import com.blaze.agent.services.AgentTaskService
import com.blaze.agent.utilities.SpeechCoordinator
...
import com.blaze.agent.agents.ClarificationAgent
import com.blaze.agent.utilities.TTSManager
import com.blaze.agent.utilities.addResponse
import com.blaze.agent.utilities.getReasoningModelApiResponse
import com.blaze.agent.utilities.FreemiumManager
import com.blaze.agent.overlay.OverlayManager
import com.blaze.agent.overlay.OverlayDispatcher
import com.blaze.agent.utilities.PandaState
import com.blaze.agent.utilities.UserProfileManager
import com.blaze.agent.utilities.VisualFeedbackManager
import com.blaze.agent.v2.AgentService
import com.blaze.agent.data.UserMemory
...
import com.blaze.agent.utilities.ServicePermissionManager
import com.blaze.agent.utilities.PandaStateManager
...
class ConversationalAgentService : Service() {
    ...
    companion object {
        ...
        const val ACTION_STOP_SERVICE = "com.blaze.agent.ACTION_STOP_SERVICE"
        var isRunning = false
